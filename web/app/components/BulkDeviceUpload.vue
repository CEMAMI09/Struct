<template>
  <div class="fixed inset-0 z-50 flex items-end justify-center bg-black/60 p-4 sm:items-center">
    <div
      ref="dialogEl"
      class="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-[#2A2F3A] bg-[#1A1D24] p-5 shadow-xl outline-none"
      role="dialog"
      aria-modal="true"
          ...
          <table class="w-full min-w-[520px] text-left text-xs">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-2 py-2 font-mono text-[#b79bff]">{{ row.macDisplay || '—' }}</td>
