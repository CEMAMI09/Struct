-- Tighten remove: only owners can remove *other* members.
-- Anyone may still leave themselves (any role). Last-owner protection remains.
...
begin
  ...
  if leaving_self then
    -- Any role can leave; block leaving if you are the sole owner.
    ...
    -- Removing someone else: owners only.
